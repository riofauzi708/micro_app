    ...
    return(
        ...
        <div className='bg-white pb-32'>
            ...
            <form className='mr-28 pr-24'>
                ...
                <label className="block text-gray-600 text-lg font-bold mb-2" htmlFor=''>
                    Visi Misi</label>
                <textarea className='block shadow outline outline-2 outline-gray-400 rounded-lg w-full h-32 p-2 text-gray-900 mb-4' />
                <label className="block text-gray-600 text-lg font-bold mb-2" htmlFor=''>
                    Alamat</label>
                <textarea className='block shadow outline outline-2 outline-gray-400 rounded-lg w-full h-32 p-2 text-gray-900 mb-8' />
                <button className="w-96 text-white text-2xl font-semibold py-2.5 px-4 rounded-lg" style={{ backgroundColor: '#5E5400' }} type="button">
                    SUBMIT
                </button>
            </form>
            </div>
